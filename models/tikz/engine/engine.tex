...
\tikzstyle{ground}=[fill,pattern=north east lines,draw=none,minimum width=0.75cm,minimum height=0.3cm]
   ...
   %draw axes
    ...
    \draw [spring] (M.south west)  node[] (left_spring){}  --++ (-1.5cm,-1.5cm) node[midway,right,xshift=0.3cm] {$k_{m}$};
    
\draw [spring] (M.south east)  node[] (right_spring){}  --++ (1.5cm,-1.5cm) node[midway,left,xshift=-0.3cm] {$k_{m}$};
