...
\tikzstyle{damper}=[thick,decoration={markings,  
  ...
  mark=at position 0.5 with 
  {
   ...
   \node (M) at (origo) [draw,thick,minimum width=5cm, minimum height=0.5cm]{};
    ...
    \draw [spring] ([yshift=0.8cm]ground.west) node (ground_fix_L) {} -- ([xshift=-0.5cm,yshift=-0.8cm]M.west) node [midway,left,xshift=-0.2cm] {$k_1, l$};

    \draw [damper] ([xshift=1cm,yshift=0.8cm]ground.west) node (ground_fix_L) {} -- ([xshift=0.5cm,yshift=-0.8cm]M.west) node at (1cm,0) [midway,left,xshift=-0.3cm] {$c_1$};
    ...
    \draw [spring] ([xshift=-1cm,yshift=0.8cm]ground.east) node (ground_fix_L) {} -- ([xshift=-0.5cm,yshift=-0.8cm]M.east) node [midway,left,xshift=-0.2cm] {$k_2, l$};

    \draw [damper] ([yshift=0.8cm]ground.east) node (ground_fix_L) {} -- ([xshift=0.5cm,yshift=-0.8cm]M.east) node at (1cm,0) [midway,left,xshift=-0.3cm] {$c_2$};
...
%     \draw [spring] (ground.north east) ++ (-0.5,0) node (ground_fix_R)  {} -- (M.east) node [midway,left] {$ k_1,l$};
    ...
    \draw[thin] (M.east)--++(1cm,0) node (force_point){};
