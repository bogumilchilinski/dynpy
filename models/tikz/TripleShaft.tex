...
\draw[thick, teal,->] (I_1)++(0.5cm,-1cm)  --++(0.35cm,1cm) --++ (-0.35cm,1cm) node[above right,xshift=-0.2cm, black] {$\varphi_1,{M_{1}} \cdot{\sin({\nu}{t}+{\delta})}$};

\draw[thick, teal,->] (I_2)++(0.5cm,-1cm)  --++(0.35cm,1cm) --++ (-0.35cm,1cm) node[above right,xshift=-0.2cm, black] {$\varphi_2,{M_{2}} \cdot{\sin({\nu}{t}+{\delta})}$};

\draw[thick, teal,->] (I_3)++(0.5cm,-1cm)  --++(0.35cm,1cm) --++ (-0.35cm,1cm) node[above right,xshift=-0.2cm, black] {$\varphi_3,{M_{3}} \cdot{\sin({\nu}{t}+{\delta})}$};
