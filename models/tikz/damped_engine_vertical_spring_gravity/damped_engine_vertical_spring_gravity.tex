...
\draw [damper] (M.south west)[xshift=0.5cm]   node (left_vertical_spring){}  --++ (0cm,-1.5cm) node[midway,left,xshift=-0.15cm,yshift=-0.3cm] {$k_{m}$};
    
\draw [damper] (M.south east)  node[] (right_vertical_spring){}  --++ (0cm,-1.5cm) node[midway,right,xshift=0.15cm,yshift=-0.3cm] {$k_{m}$};
