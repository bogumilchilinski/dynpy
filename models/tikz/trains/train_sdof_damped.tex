...
\tikzstyle{ground}=[fill,pattern=north east lines,draw=none,minimum width=0.75cm,minimum height=0.3cm]
   ...
   %draw axes
    ...
    \draw [spring] ([xshift=-0.5cm]origo)  node (k_sup_spring){}  -- ([xshift=-0.5cm]M.south) node[xshift=-0.15cm,midway,left] {$k$};
    \draw [damper] ([xshift=0.5cm]origo)  node (c_sup_spring){}  -- ([xshift=0.5cm]M.south) node[xshift=0.35cm,midway,right] {$c$};


    \draw [ultra thick] ([xshift=-1cm]k_sup_spring.west) -- ([xshift=1cm]c_sup_spring.east) node[midway] (beam_center) {};
