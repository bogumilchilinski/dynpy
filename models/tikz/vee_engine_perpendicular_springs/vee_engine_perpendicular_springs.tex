...
\draw [spring] (M.south east)  node[] (right_vertical_spring){}  --++ (0cm,-1.5cm) node[midway,right,xshift=0.15cm,yshift=-0.3cm] {$k_{m}$};
    \draw [spring] (M.south west)  node[] (left_horizontal_spring){}  --++ (-1.5cm,-0cm) node[midway,above,yshift=0.3cm] {$k_{m}$};
    
\draw [spring] (M.south east)  node[] (right_horizontal_spring){}  --++ (1.5cm,-0cm) node[midway,above,yshift=0.3cm] {$k_{m}$};
