...
#             self.m_pf: [50],
    ...
    def symbols_description(self):
        self.sym_desc_dict = {
            ...
            self.k: r'''trolley's stiffness''',
            self.lam: r'''Rayleigh's proportional damping coefficient''',
            self.l: r'lenght of the pendulum',
            self.Omega: r'excitation frequency',
            self.omega0: r'natural frequency of trolley',
            self.F: r'force amplitude',
            ...
            self.chi: r'ratio of members natural frequencies',
            self.psi: r'excitation frequency to the natural frequency of the trolley ratio',
            self.delta: r'''force amplitude to trolley's stiffness ratio''',
            self.Omega0: r'natural frequency of pendulum',
            self.tau: 'dimensionless time',
            self.x: '''trolley's displacement''',
            self.x.diff(self.ivar): '''trolley's velocity''',
