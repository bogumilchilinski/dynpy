...
class MDoFLinearizedThreePendulumsWithSprings(ComposedSystem):
    ...
    def __init__(self,
        ...
        self.Pendulum1 = Pendulum(m1, g, l, angle=phi_l, qs=[phi_l]) + Force(-F * l * cos(Omega * ivar), pos1=phi_l, qs=[phi_l])
        self.Pendulum2 = Pendulum(m2, g, l, angle=phi_c, qs=[phi_c])
        self.Pendulum3 = Pendulum(m3, g, l, angle=phi_r, qs=[phi_r]) + Force(-2* F * l* cos(Omega * ivar), pos1=phi_r, qs=[phi_r])
