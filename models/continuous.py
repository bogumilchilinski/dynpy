...
class CSBeam(ContinuousSystem):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        L_beam = (
            ...
            / 2
            * (
                A * rho * (self.w.diff(self.time)) ** 2
                - E * I * (self.w.diff(self.loc, 2)) ** 2
            )
        )
        ...
        self._sep_expr = (
            2
            * self.L.subs(
                {self.w.diff(self.time): 0, (self.w.diff(self.loc, 2)): 1}
            ).doit()
            * Symbol("k", positive=True) ** 4
        )
    ...
    def get_default_data(self):
        ...
        default_data_dict = {
            ...
            self.BC: [
                {sup_ls: 0, mb_ls: 0, sup_rs: 0, mb_rs: 0},
                {fix_ls: 0, v_ls: 0, sup_rs: 0, mb_rs: 0},
                {sup_ls: 0, mb_ls: 0, sup_rs: 0, mb_rs: 0},
                {fix_ls: 0, v_ls: 0, sup_rs: 0, mb_rs: 0},
                {sup_ls: 0, mb_ls: 0, sup_rs: 0, mb_rs: 0},
            ],
    ...
    def get_random_parameters(self):
        ...
        data_dict[self.A] = (
            L_0**2
            * random.choice([0.125, 1.25, 0.0125, 1.23, 0.128])
            / (data_dict[self.E] / E_0)
            / (data_dict[self.I] / I_0)
        ).n(3)
    ...
    def bending_moment(
        ...
        return (
            abs(
                mode.diff(self.loc, 2)
                * Symbol("E", positive=True)
                * Symbol("I", positive=True)
            )
            * amp
        )

    def mode_cross_section_side(
        self,
        mode_no,
        bc_dict=None,
        sep_expr=None,
...
class CSRod(ContinuousSystem):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        L_rod = (
            ...
            / 2
            * (
                rho_L * (self.u.diff(self.time)) ** 2
                - A * E * (self.u.diff(self.loc)) ** 2
            )
        )
        ...
        self._sep_expr = (
            2
            * self.L.subs(
                {self.u.diff(self.time): 0, (self.u.diff(self.loc)): 1}
            ).doit()
            * Symbol("k", positive=True) ** 2
        )
    ...
    def get_random_parameters(self):
        ...
        data_dict[self.A] = (
            L_0**2 * random.uniform(0.00125, 0.125) / (data_dict[self.E] / E_0)
        ).n(3)
        return data_dict
    ...
    def determine_section_side_for_mode(
        self,
        mode_no,
        bc_dict=None,
        sep_expr=None,
...
class CSString(ContinuousSystem):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._sep_expr = (
            2
            * self.L.subs(
                {self.w.diff(self.time): 0, (self.w.diff(self.loc)): 1}
            ).doit()
            * Symbol("k", positive=True) ** 2
        )
    ...
    def get_random_parameters(self):
        ...
        data_dict[self.A] = (
            L_0**2
            * random.choice([0.03, 0.031, 0.0031, 0.033, 3.1])
            / (data_dict[self.Ty] / T0)
        ).n(3)
...
class CSShaft(ContinuousSystem):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        L_shaft = (
            ...
            / 2
            * (
                rho * I * (self.phi.diff(self.time)) ** 2
                - G * I * (self.phi.diff(self.loc)) ** 2
            )
        )
        ...
        self._sep_expr = (
            2
            * self.L.subs(
                {self.phi.diff(self.time): 0, (self.phi.diff(self.loc)): 1}
            ).doit()
            * Symbol("k", positive=True) ** 2
        )
    ...
    def get_random_parameters(self):
        ...
        data_dict[self.I] = (
            L_0**4 * random.choice([1.1, 11, 110, 10, 111]) / (data_dict[self.G] / G_0)
        ).n(3)
    ...
    def mode_cross_section_diameter(
        self,
        mode_no,
        bc_dict=None,
        sep_expr=None,
...
class CSCylinder(PlaneStressProblem):
    ...
    def get_default_data(self):
        ...
        default_data_dict = {
            ...
            self.BC: [
                {in_p0: p0, out_p0: S.Zero},
                {in_p0: S.Zero, out_p0: p0},
                {in_p0: p0, out_p0: p0},
                {in_p0: -p0, out_p0: S.Zero},
                {in_p0: S.Zero, out_p0: -p0},
                {in_p0: -p0, out_p0: -p0},
...
class CSPlate(PlaneStressProblem):
    ...
    def get_default_data(self):
        ...
        default_data_dict = {
            ...
            self.BC: [
                {in_m0: m0, out_m0: S.Zero},
                {in_m0: S.Zero, out_m0: m0},
                {in_m0: m0, out_m0: m0},
                {in_m0: -m0, out_m0: S.Zero},
                {in_m0: S.Zero, out_m0: -m0},
                {in_m0: -m0, out_m0: -m0},
