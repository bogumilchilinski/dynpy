...
#                  correct_system,
#                  other_systems,
#                  answer_generator=lambda obj: (Eq(obj._eoms.doit().expand().applyfunc(
#                      simplify).expand(), Matrix([0]*len(obj.q)), evaluate=False)),
#                  **kwargs):
...
#                  correct_system,
#                  other_systems,
#                  answer_generator=lambda obj: (Eq(obj._eoms.doit().expand(
#                  ).applyfunc(simplify).expand()[0], 0, evaluate=False)),
#                  **kwargs):
...
#                  ).expand().applyfunc(simplify).expand()[0], 0, evaluate=False)),
#                  **kwargs):
...
#                      obj.approximated())._eoms[0].doit().expand(), 0, evaluate=False),
#                  **kwargs):
...
#                  correct_system,
#                  other_systems,
#                  answer_generator=lambda obj: Matrix(
#                      obj.critical_points()[0:2]),
#                  **kwargs):
...
#                  other_systems,
#                  answer_generator=lambda obj: (Eq(HarmonicOscillator(
#                      obj.linearized())._eoms.doit(), Matrix([0]*len(obj.q)), evaluate=False)),
#                  **kwargs):
...
#                      Symbol('X_s'),
#                      HarmonicOscillator(
#                          obj.linearized()).steady_solution().n(3),
#                      evaluate=False),
#                  **kwargs):
...
#                  correct_system,
#                  other_systems,
#                  answer_generator=lambda obj: Eq(Symbol('omega_h'), list(
#                      HarmonicOscillator(obj.linearized()).damped_natural_frequencies())[0]),
#                  **kwargs):
...
#                  other_systems,
#                  answer_generator=lambda obj: Eq(Symbol(
#                      'varepsilon'), (obj.small_parameter()/obj.inertia_matrix()[0]).simplify()),
#                  **kwargs):
...
#                  correct_system,
#                  other_systems,
#                  answer_generator=lambda obj: Eq(Symbol('omega')**2, (HarmonicOscillator(obj.linearized()).natural_frequencies()[
#                                                  0]**2+S('3')/4*obj.small_parameter()/obj.inertia_matrix()[0]*Symbol('a')**2).expand()),
#                  **kwargs):
