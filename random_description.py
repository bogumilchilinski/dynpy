...
summary_dict = {
    time_param: time_domain_summary_param,
...
introduction_dict = {
    gen1: sec_introduction_bank_gen1,
...
refs_dict = {fig_no: introduction_bank_fig_no, given_data: introduction_bank_given_data}
...
conclusion_bank_drive_model = [
    str(RandomDescription(conclusion_bank_varphi_rc, conclusion_bank_no_impact))
    for obj in range(30)
]
