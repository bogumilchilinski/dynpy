...
class DynamicSystemMethodsUsageComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            GuideCode(
                """eoms=SDOFWinchSystem()._eoms[0]""".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
        ...
        display(
            GuideCode(
                """solution=SDOFWinchSystem()._ode_system.solution[0]""".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
        display(
            GuideCode(
                "solution_sym=SDOFWinchSystem()._ode_system.solution".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
        ...
        display(
            GuideCode(
                """steady_solution=SDOFWinchSystem()._ode_system.steady_solution[0]""".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
