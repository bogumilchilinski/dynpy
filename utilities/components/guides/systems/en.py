...
from dynpy.utilities.components.ode.en import (
...
class DynamicSystemCallComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "A class that allows you to solve a specific problem (in this case, a problem related to the description of a system under consideration):"
            )
        )

        display(
            GuideCode(
                """from dynpy.models.mechanics import SDOFWinchSystem""".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
        ...
        display(
            Markdown(
                "Przypisujemy zaimportowany obiekt klasy do zmiennej o nazwie `dyn_sys` lub `system` w celu skrócenia jej zapisu"
            )
        )
        ...
        display(
            ReportText(
                "The way to call out the preview of the class - the so-called preview:"
            )
        )
...
class DynamicSystemMethodsUsageComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            Markdown(
                """Definiujemy zmienną eoms w celu otrzymania równania w postaci wyrażenia sympy (Do raportu z obliczeniami),
        ...
        display(
            GuideCode(
                """eoms_expr=dyn_sys._eoms[0]""".replace("SDOFWinchSystem", system_name)
            )
        )
        ...
        display(
            Markdown(
                """Definiujemy zmienną odesys w celu przeprowadzenia obliczen
        ...
        display(
            GuideCode(
                """ode_sys=dyn_sys.eoms""".replace("SDOFWinchSystem", system_name)
            )
        )
        display(ReportText("Wynik jest następujący:"))
        ...
        display(
            GuideCode(
                """ode_sys.as_eq_list()""".replace("SDOFWinchSystem", system_name)
            )
        )

        display(
            ReportText(
                "Proces tworzenia równania z wcześniej wywołanego równania ruchu (równanie początkowo jest wywoływane jako ciąg znaków reprezentujący opis danego problemu, jednak nie jest on wówczas równaniem, które możemy zastosować do obliczeń):"
            )
        )
        ...
        display(
            ReportText(
                "Słownik z losowymi wartościami parametrów symbolicznych systemu wygląda następująco:"
            )
        )
        ...
        display(
            ReportText(
                "Słownik z losowymi wartościami liczbowymi do analizy numerycznej systemu, wygląda następująco:"
            )
        )
        ...
        display(
            ReportText(
                "Tworzenie słownika (w tym przypadku z losowymi wartościami) umożliwiający nadanie wartości zmiennym:"
            )
        )

        display(
            GuideCode(
                "slownik=SDOFWinchSystem().get_random_parameters()".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
        display(
            GuideCode(
                "slownik_numerical=SDOFWinchSystem().get_numerical_parameters()".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
...
class SimulationsComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            GuideCode(
                """t_span = np.linspace(0,100,200)""".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
        ...
        display(
            ReportText("Substitution of data from a previously created dictionary:")
        )
        ...
        display(
            ReportText(
                "Using the lambdify method to convert functions to anonymous form"
            )
        )
        ...
        display(
            GuideCode(
                """eq_lambdify=lambdify(system.ivar, list(steady_solution_subs.rhs))""".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
        ...
        display(
            GuideCode(
                """df = pd.DataFrame(data=eq_lambdify(t_span))
df.T.set_index(t_span).plot()""".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
        ...
        display(
            ReportText(
                "A way to create charts directly from a previously called class:"
            )
        )
...
table_eq""".replace(
        ...
        display(
            GuideCode(report_table_define_str.replace("SDOFWinchSystem", system_name))
        )
        ...
        display(
            GuideCode(
                """table_new.to_pylatex_tikz().in_figure()""".replace(
                    "SDOFWinchSystem", system_name
                )
            )
        )
...
class DynSysCodeComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                f"""The presented code of the {system_name} class was retrieved with the help of the ObjectCode class.  """
            )
        )
...
class DynSysIntroComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "Required imports of libraries/individual classes to create the report:"
            )
        )
        display(
            ObjectCode(
        ...
        display(
            ReportText(
                "A class that allows you to solve a specific problem (in this case, a problem related to the description of a crane):"
            )
        )
        display(
            Markdown(
        ...
        display(
            ReportText(
                "The process of calling the equation of motion using the eoms method:"
            )
        )
        display(
            ObjectCode(
        ...
        display(
            ReportText(
                "The process of creating an equation from a previously called equation of motion (the equation is initially called as a string representing a description of the problem at hand, but it is not then an equation that we can use for calculations):"
            )
        )
        display(
            ObjectCode(
        ...
        display(
            ReportText(
                "Create a dictionary (in this case with random values) that allows you to assign values to variables:"
            )
        )
        display(
            ObjectCode(
...
class ODEReportComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "Aby utworzyć dokument, standardowo należy utworzyć sekcje lub rozdziały w następujący sposób:"
            )
        )
        ...
        display(
            ReportText(
                "Jeżeli chcemy żeby nasze równania ładnie wyswietlały się w dokumencie nie możemy zapominac o użyciu SympyFormula:"
            )
        )
        ...
        display(
            ReportText(
                "Co więcej, ODESystem posiada ogromną ilosć komponentów raportujących, które tworzą sekcje raportu za nas. Scieżka do ich odnalezienia jest następująca:"
            )
        )
...
class ODENumericalSimulationsComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "W pierwszej kolejności zdefiniowano parametry potrzebne do przeprowadzenia do obliczeń"
            )
        )
        ...
        display(
            ReportText(
                "Wprowadzenie systemu dynamicznego, zdefiniowano również pojawiającą się Omegę "
            )
        )
        ...
        display(
            ReportText(
                "Symulacje używając systemu dynamicznego zdefiniowanego przy użyciu modułu dynpy"
            )
        )

        display(
            ReportText(
                "Sprawdzenie za pomocą helpa czym tak na prawdę jest NumericalAnalysisDataFrame"
            )
        )
        display(ObjectCode(sym_wywolanie_helpa))

        display(
            ReportText("Wyświetlenie poszczególnych wykresów, wyników oraz tablicy")
        )
        display(ObjectCode(sym_coords))
        display(ObjectCode(sym_nadf))
        display(
            ReportText(
                "Analiza porównawcza symulacji rozwiązania analitycznego i numerycznego"
            )
        )
...
class ODESimulationComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "To od czego standardowo powinno się zacząć to importy oraz definicja zmiennych. Potrzebne importy:"
            )
        )
        ...
        display(
            ReportText(
                "Kolejny niezbędny krok to tworzenie obiektu ODE. Należy go wykonać w następujący sposób:"
            )
        )
        display(ObjectCode(ode_objrctM))
        display(
            ReportText(
                "METODA 1A: Przeprowadzenie symulacji na gotowm rozwiazaniu analitycznym poprzez użycie property solution. Samo wywołanie                                 odpowiedniego rozwiązania analitycznego pokazuje nam poniższy kod:"
            )
        )
        display(ObjectCode(ode_met_1A))
        display(
            ReportText(
                "Następnie generujemy tabele niezbędną do symulacji w taki sposób:"
            )
        )
        display(ObjectCode(ode_tab_1A))
        display(
            ReportText(
                "METODA 1B: Innym sposobem jest przeprowadzenie symulacji numerycznych bez obliczeń analitycznych. Potrzebny jest do tego taki kod: "
            )
        )
        display(ObjectCode(ode_met_1B))
        display(
            ReportText(
                "METODA 2: Trzecim sposobem generowania symulacji jest użycie NumericalAnalysisDataFrame, kod wywołania prezentuje się następująco:"
            )
        )
        display(ObjectCode(ode_met_2))
        display(
            ReportText(
                "Aby przeprowadzić symulacje konieczne jest zastosowanie metody perform simulations. Bez zastosowania tej metody dostaniemy następujący wynik:"
            )
        )
        display(
            ReportText(
                "A z jej użyciem, wszystko powinno zadziałać i dostaniemy następujący output:"
            )
        )
        display(ObjectCode(ode_met_PS))
        display(
            ReportText(
                "Dla lepszego zrozumienia zagdnień poniżej przedstawione zostało zastosowanie symulacji na konkretnym przykładzie. Skorzystamy z                           prostej klasy SpringDamperMassSystem. Na dobry początek należy zaimportować tę klasę oraz przypisać ją do zmiennej. W przeprowadzeniu                                     symulacji pomoże nam wykorzystanie metody $ode system$ w celu pozyskania równania ruchu naszego systemu dynamicznego. Aby pozyskać dane w                                 prosty sposób korzystamy z metody $get numerical parameters$ oraz wrzucamy te dane w słownik. Kod do wykonania tych czynnosci prezentuje się                             następująco: "
            )
        )
        display(ObjectCode(ode_import_example))
        display(
            ReportText(
                "Następnie stosując jedną z wyżej pokazanych metod, możemy stworzyć tabelę:"
            )
        )
        display(ObjectCode(ode_example2))
        display(
            ReportText(
                "Ostatnim krokiem jest wizualizacja danych, czyli stworzenie wykresu. Aby taki wykres uzyskać wystarczy wpisać kod widoczny na                             obrazku:"
            )
        )
...
class DynSysImplementationComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "Tworzenie klasy należy zacząć od wybrania nazwy opisującej nasz system oraz zadeklarowania jej w odpowiedni sposób, który został przedstawiony poniżej:"
            )
        )  # itp
        display(GuideCode(class_call_str))
        display(
            ReportText(
                "Następnie deklarujemy atrybuty/symbole, które są niezbędne do opisania danego obiektu"
            )
        )
        display(GuideCode(atributes_str))
        display(
            ReportText(
                "Do zdefiniowania inicjalizacji obiektu klasy z określonymi atrybutami służy poniższa struktura."
            )
        )
        display(GuideCode(innit_str))
        display(
            ReportText(
                "W tym kroku korzystamy z predefiniowanych elementów takich jak punkty materialne, dyski, itp."
            )
        )
        ...
        display(
            ReportText(
                "Sekcja ta przedstawia inicjalizację słownika zawierającego dane symboliczne do równań analitycznych systemu:"
            )
        )
        display(GuideCode(def_data_str))
        display(
            ReportText(
                "Kolejnym krokiem jest przypisanie słowników zawierających dane do symulacji numerycznych:"
            )
        )
        display(GuideCode(num_data_str))
        display(
            ReportText(
                "Ta sekcja opisuje definiowanie jednostek używanych przez system dynamiczny:"
            )
        )
        ...
        display(
            ReportText(
                "Ostatecznie kod implementacji całego systemu ma następującą postać:"
            )
        )
...
class SympyFormulaComponent(DocumentGenerationComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "Przykładowe zastosowanie komponentu do obliczeń symbolicznych, na przykładzie energii kinetycznej:"
            )
        )
...
class ODEIcsComponent(ReportComponent):
    ...
    title = (
        "ODESystem solution with set of initial conditions (ICS) component presentation"
    )
    ...
    def append_elements(self):
        ...
        ode_1 = ODESystem(
            odes=Matrix([m * x.diff(t, t) + c * x.diff(t) + k * x]),
            odes_rhs=Matrix([F * sin(mu * t)]),
            dvars=Matrix([x]),
        )
        ...
        display(
            ReportText(
                "To present solution with initial set of conditions, first you need to calculate solution:"
            )
        )
        ...
        display(
            ReportText(
                "To calculate solution with ICS, declare ics vector, and run with_ics method as shown bellow:"
            )
        )
...
class DynSysOverviewUsageComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "This guide concers in-deepth analysis of exsisting dynamic system that are basic elements of `DynPy` library."
            )
        )
        display(
            ReportText(
...
class DynSysSummaryComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "All of this models should be refactored according to bellow example:"
            )
        )
        CodeRefactorComponent(None)
...
class DynSysCompletenessCheckerVerbosedComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                """Bellow table present result of completeness check of givem dynamic systems"""
            )
        )
...
class ODESystemOverviewUsageComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "This guide concers in-deepth analysis of ODESystem solver capabilities that are crucial for simulating system from `DynPy` library."
            )
        )
...
class BasicsOfDynSysImplementationIntroComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "This guide concers basics of structure and implementation of dynamic systems in `DynPy` library."
            )
        )
        display(
            ReportText(
...
class ODESystemsUsageIntroComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "This guide concers basics of structure and usage of ODE systems in  `DynPy` library."
            )
        )
        display(
            ReportText(
...
class DynamicSystemsUsageIntroComponent(ReportComponent):
    ...
    def append_elements(self):
        ...
        display(
            ReportText(
                "This guide concers basics of structure and usage of dynamic systems in  `DynPy` library."
            )
        )
        display(
            ReportText(
