...
class TeamDataComponent(CompanyDataComponent):
    ...
    def append_elements(self):
        ...
        with self.create(Tabularx("l X l",width_argument=NoEscape(r"\textwidth"))) as company_name:
            ...
            company_data = r"""
\hspace{-8pt} \multirow{5}{*}{\includegraphics[height=2.2cm]{../dynpy/utilities/components/miscellaneous/img/WSiMR.jpg}} & \textbf{Wydział Samochodów i Maszyn Roboczych PW} & \hskip12pt\multirow{5}{*}{\begin{tabular}{r}\footnotesize\bf HARMONOGRAM \\[-0.8ex] \footnotesize sem. zimowy 2022/2023 \\[-0.4ex] \footnotesize\bf DATA \\[-0.8ex] \footnotesize \MakeUppercase{\today} \end{tabular}}\hspace{-6pt} \\
