...
\draw [spring]  (M.0) ++ (0cm,-0.0cm) -- ($ (M.0 )!0.5!(M2.180) $) node [pos=0.65,above=0.10cm](k_12l) {$k_{12l}$} node (k_12_mid){}  ;%-- (wall_1.0 );
\draw[spring] (k_12_mid.center){}  -- (M2.180 ) node [pos=0.25,above=0.10cm](k_12r) {$k_{12r}$} ;
\fill[black]  (k_12_mid) circle (0.05cm);

\draw [spring]  (M2.0) ++ (0cm,-0.0cm) -- ($ (M2.0 )!0.5!(M3.180) $) node [pos=0.65,above=0.10cm](k_23l) {$k_{23l}$} node (k_23_mid){}  ;%-- (wall_1.0 );

\draw[spring] (k_23_mid.center){}  -- (M3.180 ) node [pos=0.25,above=0.10cm](k_23r) {$k_{23r}$} ;
\fill[black]  (k_23_mid) circle (0.05cm);


\draw [spring]  (M.180) ++ (0cm,-0.0cm) -- ($ (wall_1.0 )!0.5!(M.180) $) node [pos=0.25,above=0.10cm](k_lr) {$k_{lr}$} node (k_l_mid){}  ;%-- (wall_1.0 );
\draw[spring] (k_l_mid.center){}  -- (wall_1.0 )node [pos=0.65,above=0.10cm](k_ll) {$k_{ll}$};
\fill[black]  (k_l_mid) circle (0.05cm);

%\draw [fill=black]  (M.180) ++ (0cm,0.15cm) rectangle ($ (wall_1.0 )+(0cm,-0.15cm)  $) ;

\draw [spring]  (M3.0) ++ (0cm,-0.0cm) -- ($ (wall_2.180 )!0.5!(M3.0) $) node [pos=0.25,above=0.10cm](k_rl) {$k_{rl}$} node (k_r_mid){}  ;%-- (wall_1.0 );
\draw[spring] (k_r_mid.center){}  -- (wall_2.180 )node [pos=0.65,above=0.10cm](k_rr) {$k_{rr}$};
\fill[black]  (k_r_mid) circle (0.05cm);
...
\draw [thin] (Roller1.north) --++ (0cm,1cm) node (f_l_start) {}  --+ (1.5cm,0cm) node[right] (f_l_end) {$2F_0 \cos(\Omega t)$};
\draw [-latex,thick]  (f_l_start.center)  --(f_l_end.west);

\draw [thin] (Roller3.north) --++ (0cm,1cm) node (f_p_start) {} --+  (1.5cm,0cm) node[right] (f_p_end) {$F_0 \cos(\Omega t)$};
