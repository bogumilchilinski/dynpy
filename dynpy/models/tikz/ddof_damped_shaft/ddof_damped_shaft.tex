...
\node (I_1) [fill=gray,draw,outer sep=0pt,thick,minimum width=0.5cm,xshift=-0.03cm, minimum height=4.5cm,xshift=-1cm,label=above:{$I_1$}]  at (origo) {};
\node (I_2) [fill=gray,draw,outer sep=0pt,thick,minimum width=0.5cm, minimum height=4.5cm,xshift=-4.5cm,label=above:{$I_2$}]  at (I_1) {};
\node (I_0) [fill=gray,draw,outer sep=0pt,thick,minimum width=0.5cm, minimum height=4.5cm,xshift=-9cm]  at (I_1) {};




\draw[thick,double=white,double distance=0.4cm,line cap=rect] (origo) node (start){} --++(-3cm,0) node[xshift=-0.5cm,above=+0.3cm] (Label1){$G,I_1, l_1, c_1$} -- ++ (-1cm,0) node (P_load){} -- ++ (-2.5cm,0) node[xshift=-1cm,above=+0.3cm] (Label2){$G,I_2, l_2, c_2$} -- ++ (-5.5cm,0) node (shaft_end){};
