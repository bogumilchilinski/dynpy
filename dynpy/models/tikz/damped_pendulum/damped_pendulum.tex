...
%     \draw [-stealth,line width=1.5] (bob1) --++(-1cm,0cm) node[midway, below left] {$F_{1}$};
    \draw [-stealth,line width=1.5] (bob1) -- ($(bob1)!\Fvec cm!90:(origo)$) coordinate (f1vec) node[midway,below right] {$R_c=c \cdot v$};
