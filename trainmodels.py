...
#             if Omega1 is not None: self.Omega1 = Omega1
            if Omega2 is not None: self.Omega2 = Omega2
...
#             if A is not None: self.A = A
    ...
    def components(self):
            ...
            self._train_body = RigidBody2D(self.m,
                                           self.I,
                                           pos_lin=self.z,
                                           pos_rot=self.phi,
                                           qs=self.qs)(label='body')
...
#             self.A : 0.1,
        ...
        default_data_dict[self.I]=(self.m * (self.w**2 + self.h**2)/12).subs(DDoFTrain().get_numerical_data()).n(3)
        return default_data_dict
...
#            self.A : ureg.meter,
    ...
    def resonance_velocities(self):
        ...
        display(self.v_z1.subs(self.get_numerical_data()),self.v_z2.subs(self.get_numerical_data()))
        return (self.v_z1.subs(self.get_numerical_data()),self.v_z2.subs(self.get_numerical_data()))